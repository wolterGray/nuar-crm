            ...
            <div className="club-adjust-tabs" style={{
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: "13px",
                  fontWeight: "600",
                  background: adjustTab === "stamps" ? "var(--color-accent, #B91C1C)" : "transparent",
                  color: "#FFFFFF",
                  border: 0,
                  cursor: "pointer",
                  textAlign: "center",
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: "13px",
                  fontWeight: "600",
                  background: adjustTab === "gifts" ? "var(--color-accent, #B91C1C)" : "transparent",
                  color: "#FFFFFF",
                  border: 0,
                  cursor: "pointer",
                  textAlign: "center",
                ...
                <div className="club-adjust-tabs" style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "13px",
                      fontWeight: "600",
                      background: manualAdjustmentMode === "earn" ? "var(--color-accent, #B91C1C)" : "transparent",
                      color: "#FFFFFF",
                      border: 0,
                      cursor: "pointer",
                      textAlign: "center",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "13px",
                      fontWeight: "600",
                      background: manualAdjustmentMode === "writeoff" ? "var(--color-accent, #B91C1C)" : "transparent",
                      color: "#FFFFFF",
                      border: 0,
                      cursor: "pointer",
                      textAlign: "center",
                ...
                <div className="club-adjust-tabs" style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "13px",
                      fontWeight: "600",
                      background: giftMode === "earn" ? "var(--color-accent, #B91C1C)" : "transparent",
                      color: "#FFFFFF",
                      border: 0,
                      cursor: "pointer",
                      textAlign: "center",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "13px",
                      fontWeight: "600",
                      background: giftMode === "writeoff" ? "var(--color-accent, #B91C1C)" : "transparent",
                      color: "#FFFFFF",
                      border: 0,
                      cursor: "pointer",
                      textAlign: "center",
