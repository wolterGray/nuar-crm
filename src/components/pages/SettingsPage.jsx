        ...
        <form
            ...
            <div className="settings-options">
              ...
              <label className="toggle-row">
                ...
                <span>
                  ...
                  <small>Меньше вертикальных отступов и больше данных на экране</small>
                </span>
              </label>
            </div>
          </section>
          ...
          <section className="panel settings-panel">
            ...
            <div className="settings-options">
              ...
              <label className="toggle-row">
                ...
                <span>
                  Просроченные задачи
                  <small>Напоминать о задачах со сроком сегодня и просроченных делах</small>
                </span>
              </label>
              <label className="toggle-row">
                <input
                ...
                <span>
                  Остатки расходников
                  <small>Сообщать, когда запас достиг минимального значения</small>
                </span>
              </label>
              <label>
              ...
              <label className="toggle-row">
                ...
                <span>
                  ...
                  <small>Показывать плавную карточку перед ближайшим визитом</small>
                </span>
              </label>
              <label>
          ...
          <section className="panel settings-panel">
            ...
            <div className="settings-options settings-options-grid">
              <label>
                Начало рабочего дня
                <input name="workdayStart" type="time" step="3600" defaultValue={settings.workdayStart ?? "08:00"} />
              </label>
              <label>
                Конец рабочего дня
                <input name="workdayEnd" type="time" step="3600" defaultValue={settings.workdayEnd ?? "22:00"} />
              </label>
              <label>
                Шаг временной сетки
                <select name="calendarSlotMinutes" defaultValue={settings.calendarSlotMinutes ?? 15}>
          ...
          <section className="panel settings-panel">
            ...
            <div className="settings-options">
              <p>
                ...
                клиенты, календарь, сотрудники, пакеты, услуги, задачи,
                расходники и настройки.
              </p>
